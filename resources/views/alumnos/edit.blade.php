...
<body class="container mt-5">
    ...
    <form action="{{ route('alumnos.update', $alumno->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lastname" class="form-control" id="lastname" value="{{ old('lastname', $alumno->lastname) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="age" class="form-control" id="age" value="{{ old('age', $alumno->age) }}" required>
        </div>
